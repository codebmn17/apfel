...
def test_benchmark_reports_real_speedups():
    ...
    for name in ["trim_newest_first", "trim_oldest_first", "message_text_content"]:
    ...
    for name in ["context_manager_make_session", "request_decode", "tool_call_detect", "response_encode"]:
